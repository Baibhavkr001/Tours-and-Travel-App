...
public class viewhotel extends JFrame implements Runnable {
    ...
    public void run() {
        try {
            ...
            caption.setBounds(400,5,1000,100);
            l2.add(caption);
            Thread.sleep(2800);
            l2.setVisible(false);
            l3.setVisible(true);
